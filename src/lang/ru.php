...
return [
    ...
    'Anti-bandit (2-ply with multiple PVB ply)' => 'Противоударное (2-х слойное + несколько слоев PVB)',
    'Anti Firearm (2-ply glass + 1-ply polycarbonate)' => 'Пулезащищенное (2-х слойное + 1 слой поликарбоната)',
    'Anti-bandit green (5-ply)' => 'Противоударное зеленое(5 слоев)',
    'Anti-bandit privacy (5-ply)' => '',
    'Security Clear (3-ply)' => '',
    'Blue + acoustic' => 'Синее с акустикой',
    'Blue absorbing' => 'Синее поглощающее',
    'Blue' => 'Синее',
    'Blue - solar control' => 'Синее солар',
    'Bronze' => 'Бронза',
    'Clear + acoustic' => 'Прозрачное с акустикой',
    'Clear absorbing' => 'Прозрачное поглощающее',
    'Clear with coating' => 'Прозрачное с серебряным зеркальным покрытием',
    'Clear with coating + Acoustic' => 'Прозрачное с серебряным покрытием и акустикой',
    'Coated glass with high heat reflective effect' => '',
    'Coated glass with high heat reflective effect and acoustic PVB' => '',
    'Clear' => 'Прозрачное',
    'Green + acoustic' => 'Зеленое с акустикой',
    'Green absorbing' => 'Зеленое поглощающее',
    'Green absorbing + acoustic' => 'Зеленое поглощающее с акустикой',
    'Green' => 'Зеленое',
    'Green - solar control' => 'Зеленое солар',
    'Grey' => 'Серое',
    'Light green (Japanese)' => 'Светло-зеленое (японское)',
    'Grey + acoustic' => 'Серое с акустикой',
    'Grey coated' => 'Серое с покрытием',
    'Blue top tint' => 'С синей полосой',
    'Bronze top tint' => 'С бронзовой полосой',
    'Green top tint' => 'С зеленой полосой',
    'Grey top tint' => 'С серой полосой',
    'Light green top tint' => 'Со светло-зеленой полосой',
    'Dark grey top tint' => 'С темно-серой полосой',
    'Antenna' => 'Антенна',
    ...
    'TV antenna' => 'ТВ-антенна',
    'Heating originated through coating on the glass' => '',
    'Left half' => 'Левая половина',
    'Sensor (light and/or moisture) or fittings' => 'Датчик дождя',
    ...
    'H.U.Display' => '',
    'Vin Notch' => 'Окошко под VIN-номер',
    'Hardware used for the fitting of glass' => 'С молдингом или оборудованием',
    'Encapsulation through Injection PU robot extrusion Bonded extrusion' => 'Инкапсуляция',
    'Changes to thickness' => 'Изменение толщины',
    'PVB Cut Out in coated glass' => 'Вырез в покрытии',
    'Appearance or change to silkscreen' => 'Изменение внешнего вида или изменение шелкографии',
    'Change to silkscreen and to hardware' => 'Изменение шелкографии и оборудования',
    'Appearance or change to boss' => 'Изменение внешнего вида или крепления зеркала',
    'Change to boss and logo identifying security and safety features' => 'Изменение крепления зеркала и наличие спецзнаков',
    'Change to encapsulation' => 'Изменение инкапсуляции',
    'Change to heating' => 'Изменение подогрева',
    'Change to heating and to hardware' => '',
    'Change to antenna' => 'Изменение антенны',
    'Change to antenna and to boss' => 'Изменение антенны и крепления зеркала',
    'Change to Vin Notch' => 'Изменение окошка под VIN-номер',
    'Same tint but darker' => 'Темный оттенок',
    'Change to the position of boss' => 'Изменение местоположения крепления зеркала',
    'Change to silkscreen, to sensor and to heating' => 'Изменеие шелкографии, датчика и обогрева',
    'Change to silkscreen, to boss and to hardware' => 'Изменение шелкографии, крепления зеркала и оборудования',
    'Change to silkscreen, change of boss or to the position of boss and logo indent. sp. features' => '',
    'Change to encapsulation and to position of boss' => 'Изменение инкапсуляции и местоположения крепления зеркала',
    'Change to encapsulation and to silkscreen' => 'Изменеие инкапсуляции и шелкографии',
    'Change to hardware' => 'Изменение оборудования',
    'Change to boss, to silkscreen and to encapsulation' => 'Изменеие крепления зеркала, шелкографии и инкапсуляции',
    'Change to camera bracket and to features' => '',
    'Change to boss, to silkscreen and to glass thickness' => 'Изменение крепления зеркала, шелкографии и толщины стекла',
    'Logo identifying security and safety features' => 'Наличие спецзнаков',
    'Change to hardware and logo indentifying security and safety features' => '',
    'Change to silkscreen and to Thickness' => 'Изменение шелкографии и толщины стекла',
    'Change to silkscreen and to thickness with logo indentifying security and safety features' => 'Изменение шелкографии и толщины стекла, наличие спецзнаков',
    'Change to Vin Notch and to antenna' => '',
    'Change to silkprint and to antenna' => '',
    'Change to boss and to silkscreen' => 'Изменение крепления зеркала и шелкографии',
    'Change to boss, to silkscreen and to sensor' => 'Изменение крепления зеркала, шелкографии и датчика',
    'Change to Vin Notch and to hardware' => '',
    'Change to camera and to features, to silkscreen and change of boss' => '',
    'Logo indentifying security and safety features and change to Silkscreen' => 'Наличие спецзнаков, изменение шелкографии',
    'Logo indentifying security and safety features and change to silkscreen and to Vin' => 'Наличие спецзнаков, изменение шелкографии и окошка под VIN-номер',
    ...
    'Logo indentifying security and safety features and change to sensor and to Silkcreen' => 'Наличие спецзнаков, изменение датчика и шелкографии',
    'Minor mimensional changes and change to hardware' => 'Небольшие изменения размеров и изменение оборудования',
    ...
    'Van' => '',
    'Pick-up' => '',
    'Brakelight - Refers to the following specificities identifying a brakelight : Specific silkscreen Specific Wire network Specific fitting(s) Specific Bracket(s) Complete brakelight' => 'Окно под стоп-сигнал',
    'Center part' => '',
    'Double glazed' => '',
    'Flat' => '',
    'TV Antenna' => '',
    ...
    'Appearance and change to hole' => 'Изменение внешнего вида и отверстия',
    'Change of antenna and hole' => '',
    'Change to antenna and silkscreen' => '',
    'Change to antenna and appearance or change to the shade band' => '',
    'Change of size' => 'Изменение размера',
    'Change of size and thickness' => 'Изменение размера и толщины',
    ...
    'Bodyglass-flat' => 'Боковое плоское',
    'Bodyglass-flat with accessories in pack' => '',
    'Bodyglass-left' => 'Боковое левое',
    'Bodyglass-left with accessories in pack' => '',
    'Bodyglass-right' => 'Боковое правое',
    'Bodyglass-right with accessories in pack' => '',
    'Anti firearm (2-ply) glass + 1-ply polycarbonate' => '',
    'Security clear (3-ply)' => '',
    'Blue - Privacy glass' => '',
    'Light Green (Japanese)' => '',
    'Hatchback 3 doors' => 'Хэтчбек 3 двери',
    'Hatchback 4 doors' => 'Хэтчбек 4 двери',
    'Hatchback 5 doors' => 'Хэтчбек 5 дверей',
    'Saloon/sedan 2 doors' => 'Седан 2 двери',
    'Saloon/sedan 4 doors' => 'Седан 4 двери',
    'Limousine 6 doors' => '',
    'Coupe 2 doors' => '',
    'Coupe 4 doors' => '',
    'Estate/break 3 doors' => 'Универсал 3 двери',
    'Estate/break 5 doors' => 'Универсал 5 дверей',
    'MPV 3 doors' => '',
    'MPV 4 doors' => '',
    'MPV 5 doors' => '',
    'Ranger 3 doors' => 'Джип 3 двери',
    'Ranger 5 doors' => 'Джип 5 дверей',
    ...
    'Appearance and change of hole' => 'Изменение внешнего вида и отверстия',
    ...
    'Change to size, to hole and hardware' => 'Изменение размера, отверстия и оборудования',
    ...
    'Change to silkscreen and to hole' => 'Изменение шелкографии и отверстия',
    'Change to thickness and to hole' => 'Изменение толщины и отверстия',
    'Change to size and to hole' => 'Изменение размера и отверстия',
    'Change to size and to hardware' => 'Изменение размера и оборудования',
    'Change to size and to antenna' => 'Изменение размера и антенны',
    'Change to size, to antenna and to tint of encapsulation' => 'Изменение размера, антенны и оттенка инкапсуляции',
    'Glass Roof' => '',
    'Anti-bandit clear (5 ply)' => '',
    ...
    'Guide insert' => '',
    'Joint' => '',
    'Clips + mouldings' => 'Клипсы и молдинг',
